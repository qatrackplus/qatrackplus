...
#. Set the Domain name field to your server domain and root of your QATrack
   installation (e.g. `yourcomputer/qatrack` or `123.456.1.1/qatrack`) and the
   Display name to what you want shown in the top left hand corner of your
   site.
#. Click Save
