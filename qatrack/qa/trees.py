...
class BaseTree:
    ...
    def site_text(self, site):
        ...
        text = f'{site_name} <a href="{href}" title="{title}"><i class="fa fa-cubes"></i></a>'
        return text
    ...
    def unit_text(self, unit_number):
        ...
        text = f'{uname} <a href="{href}" title="{title}"><i class="fa fa-cube"></i></a>'
        return text
    ...
    def unit_frequency_text(self, unit_number, freq_slug):
        ...
        text = f'{freq_name} <a href="{href}" title="{title}"><i class="fa fa-clock-o"></i></a>'
        return text
    ...
    def utc_text(self, utc_id, utc_name, unit_name):
        ...
        text = f'<a href="{href}?next={next_}" title="{title}">{utc_name} <i class="fa fa-list"></i></a>'
        return text
...
class BootstrapCategoryTree(BaseTree):
            ...
            .annotate(
                cat_tree_id=Case(
                    ...
                    When(
                        ...
                        then=F(
                            'test_list_cycle__testlistcyclemembership__test_list__testlistmembership__test__category__tree_id'
                        ),  # noqa: E501
                    ),
                    When(
                ...
                cat_level=Case(
                    ...
                    When(
                        test_list_cycle__testlistcyclemembership__test_list__testlistmembership__test__category__tree_id__isnull=False,  # noqa: E501
                        then=F(
                            'test_list_cycle__testlistcyclemembership__test_list__testlistmembership__test__category__level'
                        ),  # noqa: E501
                    ),
                    When(
                        test_list_cycle__testlistcyclemembership__test_list__children__child__testlistmembership__test__category__tree_id__isnull=False,  # noqa: E501
    ...
    def unit_category_text(self, unit_number, category_id):
        ...
        text = '{} <a href="{}" title="{}"><i class="fa fa-tag fa-fw"></i></a>'.format(cat['name'], href, title)
        return text
