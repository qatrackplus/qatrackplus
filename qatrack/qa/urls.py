...
urlpatterns = patterns('',
    ...
    url(r"^charts/export/$", charts.ExportToCSV.as_view(), name="export_data"),
    ...
    # review utc's
    url(r"^review/all/(?P<data>data/)?$", review.UTCReview.as_view(), name="review_all"),
    url(r"^review/utc/(?P<pk>\d+)/(?P<data>data/)?$", review.UTCInstances.as_view(), name="review_utc"),
    url(r"^review/frequency/$", review.ChooseFrequencyForReview.as_view(), name="choose_review_frequency"),
    url(r"^review/frequency/(?P<frequency>[/\w-]+?)/(?P<data>data/)?$", review.UTCFrequencyReview.as_view(), name="review_by_frequency"),
    url(r"^review/unit/$", review.ChooseUnitForReview.as_view(), name="choose_review_unit"),
    url(r"^review/unit/(?P<unit_number>[/\d]+)/(?P<data>data/)?$", review.UTCUnitReview.as_view(), name="review_by_unit"),

    # test list instances
    url(r"^session/details/(?P<data>data/)?$", base.TestListInstances.as_view(), name="complete_instances"),
