...
urlpatterns = [
    ...
    url(
        r'^session/details(?:/(?P<pk>\d+))?/$', review.TestListInstanceDetails.as_view(), name='view_test_list_instance'
    ),
    url(
        r'^session/delete(?:/(?P<pk>\d+))?/$', review.TestListInstanceDelete.as_view(), name='delete_test_list_instance'
    ),
