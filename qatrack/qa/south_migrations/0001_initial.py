...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(
            "qa_unittestcollection_visible_to",
            (
                ("id", models.AutoField(verbose_name="ID", primary_key=True, auto_created=True)),
                (
                    "unittestcollection",
                    models.ForeignKey(orm["qa.unittestcollection"], on_delete=models.CASCADE, null=False),
                ),
        ...
        db.create_table(
            ...
            (
                ...
                (
                    ...
                    self.gf("django.db.models.fields.related.ForeignKey")(to=orm["qa.UnitTestCollection"]),
                ),
                ("test_list", self.gf("django.db.models.fields.related.ForeignKey")(to=orm["qa.TestList"])),
                ("work_started", self.gf("django.db.models.fields.DateTimeField")(db_index=True)),
                (
    ...
    models = {
        ...
        "qa.unittestcollection": {
            ...
            "visible_to": (
                "django.db.models.fields.related.ManyToManyField",
                [],
                {"related_name": "'test_collection_visibility'", "symmetrical": "False", "to": "orm['auth.Group']"},
            ),
        },
        "qa.unittestinfo": {
