...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(
            ...
            self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['qa.TestListInstance']),
        )
    ...
    def backwards(self, orm):
        ...
        db.alter_column(
            'qa_testinstance',
            'test_list_instance_id',
            self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qa.TestListInstance'], null=True),
        )
