...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(
            "qa_testlistinstance", "day", self.gf("django.db.models.fields.IntegerField")(default=0), keep_default=False
        )
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TestListInstance.modified'
        db.alter_column(
            "qa_testlistinstance", "modified", self.gf("django.db.models.fields.DateTimeField")(auto_now=True)
        )
