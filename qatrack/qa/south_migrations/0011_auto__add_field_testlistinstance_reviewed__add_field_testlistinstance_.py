...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('qa_testlistinstance', 'reviewed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestListInstance.reviewed_by'
        db.add_column('qa_testlistinstance', 'reviewed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='test_list_instance_reviewer', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TestListInstance.all_reviewed'
        db.add_column('qa_testlistinstance', 'all_reviewed',
