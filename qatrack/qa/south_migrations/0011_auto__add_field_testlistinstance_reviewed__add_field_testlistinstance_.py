...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'TestListInstance.reviewed'
        db.add_column(
            "qa_testlistinstance",
            "reviewed",
        ...
        # Adding field 'TestListInstance.reviewed_by'
        db.add_column(
            "qa_testlistinstance",
            "reviewed_by",
            self.gf("django.db.models.fields.related.ForeignKey")(
                blank=True, related_name="test_list_instance_reviewer", null=True, to=orm["auth.User"]
            ),
            keep_default=False,
        )

        # Adding field 'TestListInstance.all_reviewed'
        db.add_column(
            "qa_testlistinstance",
            "all_reviewed",
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TestListInstance.reviewed_by'
        db.delete_column("qa_testlistinstance", "reviewed_by_id")
    ...
    models = {
        ...
        "qa.unittestcollection": {
            ...
            "frequency": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"to": "orm['qa.Frequency']", "null": "True", "blank": "True"},
            ),
            "id": ("django.db.models.fields.AutoField", [], {"primary_key": "True"}),
            "last_instance": (
                "django.db.models.fields.related.ForeignKey",
