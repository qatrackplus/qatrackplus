...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        if 'sql_server' in engine:
            ...
            db.alter_column(
                'qa_tolerance', 'name', self.gf('django.db.models.fields.CharField')(unique=False, max_length=255)
            )
    ...
    def backwards(self, orm):
        db.add_column(
            'qa_tolerance', 'name', models.CharField(max_length=255, default='<Tolerance(Auto)>'), keep_default=False
        )
