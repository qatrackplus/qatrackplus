    ...
    def forwards(self, orm):
        ...
        if "sql_server" not in engine:
            db.alter_column(
                ...
                "frequency_id",
                self.gf("django.db.models.fields.related.ForeignKey")(to=orm["qa.Frequency"], null=True),
            )
        else:
    ...
    def backwards(self, orm):
        ...
        if "sql_server" not in engine:
            db.alter_column(
                "qa_unittestcollection",
                "frequency_id",
                self.gf("django.db.models.fields.related.ForeignKey")(default=None, to=orm["qa.Frequency"]),
            )
        else:
