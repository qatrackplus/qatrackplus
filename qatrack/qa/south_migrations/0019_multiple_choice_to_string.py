...
class Migration(DataMigration):
        ...
        for test in mc_tests:
            for ti in list(TestInstance.objects.filter(unit_test_info__test=test).exclude(value=None)):
                try:
                    ...
                    raise ValueError(
                        "Migration 19 failed on TestInstance %d. %d is no longer a valid choice" % (ti.pk, ti.value)
                    )
    ...
    def backwards(self, orm):
        ...
        for test in mc_tests:
            for ti in list(
                TestInstance.objects.filter(unit_test_info__test=test)
                .exclude(string_value=None)
                ...
                try:
                    ...
                    raise ValueError(
                        "Backwards migration 19 failed on TestInstance %d. %s is no longer a valid choice"
                        % (ti.pk, ti.string_value)
                    )
    ...
    models = {
        ...
        "qa.testlist": {
            ...
            "created_by": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"related_name": "u'qa_testlist_created'", "to": "orm['auth.User']"},
            ),
            "description": ("django.db.models.fields.TextField", [], {"null": "True", "blank": "True"}),
            "id": ("django.db.models.fields.AutoField", [], {"primary_key": "True"}),
            "modified": ("django.db.models.fields.DateTimeField", [], {"auto_now": "True", "blank": "True"}),
            "modified_by": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"related_name": "u'qa_testlist_modified'", "to": "orm['auth.User']"},
            ),
        ...
        "qa.testlistcycle": {
            ...
            "created_by": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"related_name": "u'qa_testlistcycle_created'", "to": "orm['auth.User']"},
            ),
            "description": ("django.db.models.fields.TextField", [], {"null": "True", "blank": "True"}),
            "id": ("django.db.models.fields.AutoField", [], {"primary_key": "True"}),
            "modified": ("django.db.models.fields.DateTimeField", [], {"auto_now": "True", "blank": "True"}),
            "modified_by": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"related_name": "u'qa_testlistcycle_modified'", "to": "orm['auth.User']"},
            ),
            "name": ("django.db.models.fields.CharField", [], {"max_length": "255", "db_index": "True"}),
            "slug": ("django.db.models.fields.SlugField", [], {"unique": "True", "max_length": "50"}),
            "test_lists": (
