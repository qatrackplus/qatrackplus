...
def get_content_type(orm, app_label, model_name):
    ...
    opts = orm[f'{app_label}.{model_name}']._meta.concrete_model._meta
    return orm['contenttypes.ContentType'].objects.get_or_create(
        app_label=app_label, model=model_name, defaults={'name': smart_str(opts.verbose_name_raw)}
    )
