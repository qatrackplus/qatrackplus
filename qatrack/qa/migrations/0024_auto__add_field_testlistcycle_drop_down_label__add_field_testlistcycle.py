...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'qa_testlistcycle', 'drop_down_label')

        # Deleting field 'TestListCycle.day_option_text'
        db.delete_column(u'qa_testlistcycle', 'day_option_text')
