...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='tolerance',
            field=models.ForeignKey(
                blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='qa.Tolerance'
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                ...
                limit_choices_to=models.Q(
                    models.Q(('app_label', 'qa'), ('model', 'testlist')),
                    models.Q(('app_label', 'qa'), ('model', 'testlistcycle')),
                    _connector='OR',
                ),
                on_delete=django.db.models.deletion.PROTECT,
