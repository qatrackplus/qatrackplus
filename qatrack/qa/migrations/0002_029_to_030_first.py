    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True, help_text='Any extra javascript to run when loading perform page', null=True
            ),
        ),
        migrations.AddField(
            model_name='testlistcycle',
        ...
        migrations.AddField(
            ...
            name='due_date',
            field=models.DateTimeField(
                blank=True, help_text='When was this session due when it was performed', null=True
            ),
        ),
