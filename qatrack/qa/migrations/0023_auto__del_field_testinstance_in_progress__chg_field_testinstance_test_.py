...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'qa_testinstance', 'in_progress')


        # Changing field 'TestInstance.test_list_instance'
        db.alter_column(u'qa_testinstance', 'test_list_instance_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['qa.TestListInstance']))

    def backwards(self, orm):
        # Adding field 'TestInstance.in_progress'
        db.add_column(u'qa_testinstance', 'in_progress',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


        # Changing field 'TestInstance.test_list_instance'
        db.alter_column(u'qa_testinstance', 'test_list_instance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qa.TestListInstance'], null=True))
    ...
    models = {
        ...
        u'qa.testinstance': {
            ...
            'test_list_instance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['qa.TestListInstance']"}),
