...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'qa.unittestcollection': {
            ...
            'visible_to': ('django.db.models.fields.related.ManyToManyField', [], {'default': '[<Group: Therapists>, <Group: Tomo Team>, <Group: Physics Techs>, <Group: Physics>, <Group: Electronics>]', 'related_name': "'test_collection_visibility'", 'symmetrical': 'False', 'to': "orm['auth.Group']"})
        },
        'qa.unittestinfo': {
