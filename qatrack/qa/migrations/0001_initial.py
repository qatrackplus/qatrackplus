    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=15,
                        choices=[
                            (b"not_done", b"Not Done"),
                            (b"ok", b"OK"),
                            (b"tolerance", b"Tolerance"),
                            (b"action", b"Action"),
                            (b"no_tol", b"No Tol Set"),
                        ],
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nominal_interval",
                    models.PositiveIntegerField(help_text="Nominal number of days between test completions"),
                ),
                (
                    "due_interval",
                    models.PositiveIntegerField(
                        help_text="How many days since last completed until a test with this frequency is shown as due"
                    ),
                ),
                (
                    "overdue_interval",
                    models.PositiveIntegerField(
                        help_text="How many days since last completed until a test with this frequency is shown as over due"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default=b"numerical",
                        max_length=15,
                        choices=[(b"numerical", b"Numerical"), (b"boolean", b"Yes / No")],
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.SlugField(
                        ...
                        max_length=128,
                        verbose_name=b"Macro name",
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        help_text="A concise description of what this test is for (optional. You may use HTML markup)",
                        null=True,
                        blank=True,
                    ),
                ),
                ...
                (
                    "hidden",
                    models.BooleanField(
                        default=False, help_text="Don't display this test when performing QA", verbose_name="Hidden"
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Allow users to skip this test without a comment",
                        verbose_name="Skip without comment",
                    ),
                ),
                (
                    "display_image",
                ...
                (
                    "constant_value",
                    models.FloatField(help_text="Only required for constant value types", null=True, blank=True),
                ),
                (
                    "calculation_procedure",
                    models.TextField(
                        help_text="For Composite Tests Only: Enter a Python snippet for evaluation of this test.",
                        null=True,
                        blank=True,
                    ),
                ),
                ...
                (
                    "category",
                    models.ForeignKey(
                        help_text="Choose a category for this test", to="qa.Category", on_delete=models.PROTECT
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.FloatField(
                        help_text="For boolean Tests a value of 0 equals False and any non zero equals True", null=True
                    ),
                ),
                ("string_value", models.CharField(max_length=1024, null=True, blank=True)),
                (
                    "skipped",
                    models.BooleanField(default=False, help_text="Was this test skipped for some reason (add comment)"),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text=b"Format DD-MM-YY hh:mm (hh:mm is 24h time e.g. 31-05-12 14:30)",
                        db_index=True,
                    ),
                ),
                ...
                (
                    "reviewed_by",
                    models.ForeignKey(
                        blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_default",
                    models.BooleanField(
                        default=False, help_text="Check to make this status the default for new Test Instances"
                    ),
                ),
                (
                    "requires_review",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(help_text="A short unique name for use in the URL of this list", unique=True),
                ),
                (
                    "description",
                    models.TextField(
                ...
                (
                    "warning_message",
                    models.CharField(
                        default=b"Do not treat",
                        help_text="Message given when a test value is out of tolerance",
                        max_length=255,
                    ),
                ),
                (
                    "created_by",
                    models.ForeignKey(
                        related_name="qa_testlist_created",
                        editable=False,
                        to=settings.AUTH_USER_MODEL,
                        on_delete=models.PROTECT,
                    ),
                ...
                (
                    "modified_by",
                    models.ForeignKey(
                        related_name="qa_testlist_modified",
                        editable=False,
                        to=settings.AUTH_USER_MODEL,
                        on_delete=models.PROTECT,
                    ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text="Choose any sublists that should be performed as part of this list.",
                        to="qa.TestList",
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "day_option_text",
                    models.CharField(
                        default=b"day", max_length=8, choices=[(b"day", b"Day"), (b"tlname", b"Test List Name")]
                    ),
                ),
                (
                    "created_by",
                    models.ForeignKey(
                        related_name="qa_testlistcycle_created",
                        editable=False,
                        to=settings.AUTH_USER_MODEL,
                        on_delete=models.PROTECT,
                    ),
                ...
                (
                    "modified_by",
                    models.ForeignKey(
                        related_name="qa_testlistcycle_modified",
                        editable=False,
                        to=settings.AUTH_USER_MODEL,
                        on_delete=models.PROTECT,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "act_low",
                    models.FloatField(
                        help_text="Value of lower Action level", null=True, verbose_name="Action Low", blank=True
                    ),
                ),
                (
                    "tol_low",
                    models.FloatField(
                        help_text="Value of lower Tolerance level", null=True, verbose_name="Tolerance Low", blank=True
                    ),
                ),
                (
                    "tol_high",
                    models.FloatField(
                        help_text="Value of upper Tolerance level", null=True, verbose_name="Tolerance High", blank=True
                    ),
                ),
                (
                    "act_high",
                    models.FloatField(
                        help_text="Value of upper Action level", null=True, verbose_name="Action High", blank=True
                    ),
                ),
                (
                    "mc_pass_choices",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "active",
                    models.BooleanField(
                        default=True, help_text="Uncheck to disable this test on this unit", db_index=True
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        to="auth.Group",
                        help_text="QA group that this test list should nominally be performed by",
                        null=True,
                        on_delete=models.PROTECT,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tolerance",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.SET_NULL, blank=True, to="qa.Tolerance", null=True
                    ),
                ),
                ("unit", models.ForeignKey(to="units.Unit", on_delete=models.PROTECT)),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text="Which tests does this list contain", to="qa.Test", through="qa.TestListMembership"
            ),
        ),
        migrations.AddField(
