    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text='Select which Test Lists should be included in this notification. Leave blank to include all Test Lists',
                to='qa.TestList',
            ),
        ),
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text='Select which Units should be included in this notification. Leave blank to include all units',
                to='units.Unit',
            ),
        ),
        migrations.AlterField(
