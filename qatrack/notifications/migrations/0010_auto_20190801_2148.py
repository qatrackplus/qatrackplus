        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "test_lists",
                    models.ManyToManyField(
                        help_text="Select which Test Lists should be included in this notification group.",
                        to="qa.TestList",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "units",
                    models.ManyToManyField(
                        help_text="Select which Units should be included in this notification group.", to="units.Unit"
                    ),
                ),
            ],
        ),
