        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            (0, "Notify About All Service Event Schedule Due Dates"),
                            (10, "Notify About Scheduled Service Events Currently Due & Overdue"),
                            (
                                20,
                                "Notify About Scheduled Service Events Currently Due & Overdue, and Upcoming Due Dates",
                            ),
                            (30, "Notify About Scheduled Service Events Upcoming Due Dates Only"),
                        ],
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Check to send notices even if there's no QC to currently notify about",
                        verbose_name="Send Empty Notices",
                    ),
                ),
                (
                    "recurrences",
                    recurrence.fields.RecurrenceField(
                        default="",
                        help_text="Define the schedule this notification should be sent on.",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="How many days in the future should notices about upcoming QC due dates include. A value of zero will only include test lists due today.",
                        null=True,
                        verbose_name="Future Days",
                    ),
                ),
