        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            (0, "Notify about all Test Lists Due Dates"),
                            (10, "Notify about Test Lists currently Due & Overdue"),
                            (20, "Notify about Test Lists Upcoming, Due & Overdue"),
                            (30, "Notify about Upcoming Test Lists Due Dates Only"),
                        ],
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Select which group of Test Lists this notification should be limited to. Leave blank to include all Test Lists.",
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="notifications.TestListGroup",
                        verbose_name="Test List Group filter",
                    ),
                ),
                (
                    "units",
