            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text='Select which Part Categories should be included in this notification group.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                'low_inventory',
                                "Notify when inventory for a part falls below it's Low Inventory threshold",
                            )
                        ],
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text='Select which group of parts this notification should be limited to. Leave blank to include all parts',
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to='notifications.PartCategoryGroup',
                        verbose_name='Part Group filter',
                    ),
                ),
                (
                    'recipients',
