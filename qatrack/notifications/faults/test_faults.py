...
class TestFaultNoticeEmails(TestCase):
    ...
    def test_email_sent(self):
        ...
        notification = FaultNotice.objects.create(
            notification_type=FaultNotice.TOLERANCE,
    ...
    def test_email_sent_for_completion(self):
        ...
        FaultNotice.objects.create(
            notification_type=FaultNotice.COMPLETED,
            recipients=self.recipients,
        )
    ...
    def test_follow_up_email_scheduled(self):
        ...
        FaultNotice.objects.create(
            notification_type=FaultNotice.FOLLOW_UP,
            follow_up_days=1,
            test_lists=self.testlist_group,
            recipients=self.recipients,
        )
...
class TestFaultNoticeModel:
    ...
    def test_str(self):
        n = FaultNotice(pk=1, notification_type=FaultNotice.FOLLOW_UP)
