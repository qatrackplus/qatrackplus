...
Kept separate from the 0016 baseline that precedes it: that one is a
mechanical no-op sweep of verbose_name labels, this is a deliberate change of
behaviour, and the two should not have to be reviewed or reverted together.
"""
