            ...
            fields=[
                ...
                (
                    ...
                    recurrence.fields.RecurrenceField(
                        help_text="Define the schedule this report should be sent with.", verbose_name="Schedule"
                    ),
                ),
                (
                    "time",
                    models.TimeField(
                        ...
                        help_text="Set the time of day this report should be sent (00:00-23:59)",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Enter a comma separated list of extra emails this report should be sent to",
                        verbose_name="Extra recipient emails",
                    ),
                ),
            ...
            field=models.CharField(
                choices=[
                    (
                        "General",
                        [
                            ("qc-summary-by-date", "QC Summary"),
                            ("utc", "Test List Instances"),
                            ("test_data", "Test Instance Values"),
                        ],
                    ),
                    ("Scheduling", [("next_due", "Next Due Dates for QC"), ("due_and_overdue", "Due and Overdue QC")]),
                ],
                max_length=128,
            ),
        ),
