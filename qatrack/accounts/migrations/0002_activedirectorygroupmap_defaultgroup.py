    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad_group', models.CharField(help_text='Enter the name of the group from your Active Directory Server.', max_length=255, unique=True, verbose_name='Active Directory Group')),
