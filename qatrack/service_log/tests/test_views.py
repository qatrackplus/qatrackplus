...
class TestPartViews(TestCase):
    ...
    def test_low_parts_pdf(self):

        response = self.client.get(reverse('low_parts_pdf'))
        self.assertTrue('attachement; filename=low-parts_' in response['Content-Disposition'])
