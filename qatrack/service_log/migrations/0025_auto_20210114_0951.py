    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text='Next time this service event schedule is due',
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text='Uncheck to disable scheduling of this service event template',
                        verbose_name='active',
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text='Describe the problem leading to this service event',
                        null=True,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text='Describe the work done during this service event',
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        default=True,
                        help_text='Check this option to make "Review" mandatory for Service Events created with this template',
                        verbose_name='is review required',
                    ),
                ),
                (
                    'name',
                    models.CharField(
                        help_text='Give this template a concise name', max_length=255, verbose_name='name'
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text='Select the Return to Service QC that must be performed for this Service Event Type',
                        related_name='service_event_templates',
                        to='qa.TestListCycle',
                        verbose_name='return to service test list cycles',
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name='service_event_templates',
                        to='qa.TestList',
                        verbose_name='return to service test lists',
                    ),
                ),
            ],
            options={
        ...
        migrations.AlterModelOptions(
            ...
            options={
                ...
                'verbose_name_plural': 'unit service area memberships',
            },
        ),
        migrations.AddField(
            ...
            field=models.DateTimeField(
                blank=True, help_text='When was this service event due when it was performed', null=True
            ),
        ),
        migrations.AddField(
            model_name='serviceevent',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text='Select the group. Leave blank to allow choosing any user.',
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to='auth.Group',
                verbose_name='group',
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False,
                help_text='Allow selecting multiple users when using this group linker',
                verbose_name='multiple users',
            ),
        ),
        migrations.AlterField(
            model_name='grouplinker',
            name='name',
            field=models.CharField(
                help_text='Enter this group\'s display name (ie: "Physicist reported to")',
                max_length=64,
                verbose_name='name',
            ),
        ),
        ...
        migrations.AlterField(
            ...
            name='group_linker',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to='service_log.GroupLinker', verbose_name='group linker'
            ),
        ),
        migrations.AlterField(
            model_name='grouplinkerinstance',
            name='service_event',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='service_log.ServiceEvent', verbose_name='service event'
            ),
        ),
        migrations.AlterField(
            model_name='grouplinkerinstance',
        ...
        migrations.AlterField(
            ...
            field=models.DurationField(
                help_text='The time this person spent on this service event', verbose_name='time'
            ),
        ),
        migrations.AlterField(
            model_name='hours',
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(
                help_text='Enter a short name for this service area', max_length=32, unique=True, verbose_name='name'
            ),
        ),
        migrations.AlterField(
            model_name='servicearea',
            ...
            field=models.ManyToManyField(
                ...
                through='service_log.UnitServiceArea',
                to='units.Unit',
                verbose_name='units',
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                help_text='Describe the problem leading to this service event', verbose_name='problem description'
            ),
        ),
        migrations.AlterField(
            model_name='serviceevent',
            ...
            field=models.TextField(
                blank=True,
                help_text='Describe any safety precautions taken',
                null=True,
                verbose_name='safety precautions',
            ),
        ),
        migrations.AlterField(
            model_name='serviceevent',
        ...
        migrations.AlterField(
            ...
            name='service_status',
            field=models.ForeignKey(
                help_text='The current status of this service event',
                on_delete=django.db.models.deletion.PROTECT,
                to='service_log.ServiceEventStatus',
                verbose_name='status',
            ),
        ),
        migrations.AlterField(
            ...
            name='service_type',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to='service_log.ServiceType', verbose_name='service type'
            ),
        ),
        migrations.AlterField(
            model_name='serviceevent',
            ...
            field=models.ForeignKey(
                ...
                verbose_name='initiating test list instance',
            ),
        ),
        migrations.AlterField(
            model_name='serviceevent',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                ...
                related_name='+',
                to=settings.AUTH_USER_MODEL,
                verbose_name='status last changed by',
            ),
        ),
        migrations.AlterField(
            model_name='serviceevent',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                help_text='Choose a colour for this service event status',
                max_length=22,
                validators=[
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=True,
                help_text='Do service events with this status require review?',
                verbose_name='is review required',
            ),
        ),
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(
                help_text='Enter a short name for this service status', max_length=32, unique=True, verbose_name='name'
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                help_text='Give a brief description of this service type',
                max_length=512,
                null=True,
                verbose_name='description',
            ),
        ...
        migrations.AlterField(
            ...
            name='is_active',
            field=models.BooleanField(
                default=True, help_text='Set to false if service type is no longer used', verbose_name='is active'
            ),
        ),
        migrations.AlterField(
            model_name='servicetype',
            ...
            field=models.BooleanField(
                default=True,
                help_text='Enable this flag to disable the "Review Required" checkbox for new Service Events',
                verbose_name='is review required',
            ),
        ),
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(
                help_text='Enter a short name for this service type', max_length=32, unique=True, verbose_name='name'
            ),
        ),
        migrations.AlterField(
            ...
            name='first_name',
            field=models.CharField(
                help_text="Enter this person's first name", max_length=32, verbose_name='first name'
            ),
        ),
        migrations.AlterField(
            model_name='thirdparty',
        ...
        migrations.AlterField(
            ...
            name='vendor',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to='units.Vendor', verbose_name='vendor'
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='service_area',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='service_log.ServiceArea', verbose_name='service area'
            ),
        ),
        migrations.AlterField(
            model_name='unitservicearea',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text='Select the Service Area this Service Event Template applies to. Leave blank to create a generic template.',
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to='service_log.ServiceArea',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text='Select the Service Type this Service Event Template applies to. Leave blank to create a generic template.',
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to='service_log.ServiceType',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to='service_log.ServiceEventTemplate',
                verbose_name='service event template',
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                to='service_log.ServiceEventSchedule',
                verbose_name='service event schedule',
            ),
        ),
        migrations.AddField(
