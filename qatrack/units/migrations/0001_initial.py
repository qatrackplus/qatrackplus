    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'name',
                    models.CharField(
                        help_text='Descriptive name for this modality', unique=True, max_length=255, verbose_name='Name'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'serial_number',
                    models.CharField(help_text='Optional serial number', max_length=256, null=True, blank=True),
                ),
                (
                    'location',
                    models.CharField(help_text='Optional location information', max_length=256, null=True, blank=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'model',
                    models.CharField(
                        help_text='Optional model name for this group', max_length=50, null=True, blank=True
                    ),
                ),
            ],
        ),
