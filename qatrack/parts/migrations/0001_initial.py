    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alt_part_number",
                    models.CharField(blank=True, help_text="Alternate part number", max_length=32, null=True),
                ),
                ("description", models.TextField(help_text="Brief description of this part")),
                (
                    "quantity_min",
                    models.PositiveIntegerField(
                        default=0, help_text="Notify when the number parts falls below this number in storage"
                    ),
                ),
                (
                    "quantity_current",
                    models.PositiveIntegerField(
                        default=0, editable=False, help_text="The number of parts in storage currently"
                    ),
                ),
                (
                    "cost",
                    models.DecimalField(
                        decimal_places=2, default=0, help_text="Cost of this part", max_digits=10, blank=True, null=True
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Additional comments about this part", max_length=255, null=True
                    ),
                ),
                (
                    "is_obsolete",
                    models.BooleanField(default=False, help_text="Is this part now obsolete", verbose_name="Obsolete"),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "part",
                    models.ForeignKey(
                        help_text="Select the part used", on_delete=django.db.models.deletion.CASCADE, to="parts.Part"
                    ),
                ),
                (
                    "service_event",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Additional comments about this supplier", max_length=255, null=True
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Category for this part",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            name="from_storage",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="parts.Storage"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="storage",
