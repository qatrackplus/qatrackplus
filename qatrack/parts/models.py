...
class Room(models.Model):
    ...
    name = models.CharField(max_length=32, help_text=_l('Name of room or room number'))
...
class Part(models.Model):
    ...
    name = models.CharField(help_text=_l('Brief name describing this part'), max_length=255)
    ...
    quantity_current = models.PositiveIntegerField(
        help_text=_l('The number of parts in storage currently'), default=0, editable=False
    )
...
class PartUsed(models.Model):
    ...
    part = models.ForeignKey(Part, help_text=_l('Select the part used'), on_delete=models.CASCADE)
